...
) ENGINE = InnoDB AUTO_INCREMENT = 485 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'tabla de estudiantes de los cursos' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 135 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'tabla de log de ingreso al sistema x estudiante\r\nrevision VE' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 85 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'InnoDB free: 7168 kB; (`to`) REFER `edunet2/admin`(`id`) ON ' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 158 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'InnoDB free: 7168 kB; (`to`) REFER `edunet2/estudiante`(`id`' ROW_FORMAT = Compact;
